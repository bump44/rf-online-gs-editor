...
export default new Struct().fromSchema1([
  ...
  { child: { type: Number, name: 'nOreList', len: 32 } },
  { child: { type: Number, name: 'nOreLevel', len: 32 } },
  { child: { type: Number, name: 'nOreProb', len: 32 } },
  ...
  { child: { type: Number, name: 'nProcessPoint', len: 32 } }, // ?
  ...
  { child: { type: Number, name: 'nMinCRandom', len: 32 } },
  { child: { type: Number, name: 'nMaxCRandom', len: 32 } },
  { child: { type: Number, name: 'nProcessPrice', len: 32 } },
