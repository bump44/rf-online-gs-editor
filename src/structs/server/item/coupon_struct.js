...
export default new Struct().fromSchema1([
  ...
  { child: { type: Number, name: 'nCouponItemPart', len: 32 } },
  { child: { type: Number, name: 'nDiscount', len: 32 } },
  { child: { type: Number, name: 'nPoint', len: 32 } },
  ...
  { child: { type: Number, name: 'nStoragePart', len: 32 } },
