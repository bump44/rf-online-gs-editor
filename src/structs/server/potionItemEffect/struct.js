...
export default new Struct().fromSchema1([
  ...
  { child: { type: Number, name: 'bActivate', len: 32 } },
  { child: { type: Number, name: 'bEnable', len: 32 } },
  ...
  { child: { type: Number, name: 'bFixshield', len: 32 } },
  ...
  { child: { type: Number, name: 'bCumulType', len: 32 } },
