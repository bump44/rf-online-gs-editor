...
export default new Struct().fromSchema1([
  ...
  { child: { type: Number, name: 'fUnkFloat_1', len: 32, as: 'float' } },
  { child: { type: Number, name: 'fUnkFloat_2', len: 32, as: 'float' } },
  ...
  { child: { type: Number, name: 'nUnitHead', len: 32 } },
  { child: { type: Number, name: 'nUnitUpper', len: 32 } },
  { child: { type: Number, name: 'nUnitLower', len: 32 } },
  { child: { type: Number, name: 'nUnitArm', len: 32 } },
  { child: { type: Number, name: 'nUnitShoulder', len: 32 } },
  { child: { type: Number, name: 'nUnitBack', len: 32 } },
  { child: { type: Number, name: 'nBullet1', len: 32 } },
  { child: { type: Number, name: 'nBullet2', len: 32 } },
  { child: { type: Boolean, name: 'bDestory', len: 32 } },
