...
const makeSelectProjectsImports = () =>
  createSelector(
    selectGlobal,
    globalState => globalState.get('projectsImports'),
  );

const makeSelectProjectsImportsServerMaps = () =>
  createSelector(
    selectGlobal,
    globalState => globalState.get('projectsImportsServerMaps'),
  );

const makeSelectProjectsExports = () =>
  createSelector(
    selectGlobal,
    globalState => globalState.get('projectsExports'),
  );

const makeSelectProjectsExportsServerMaps = () =>
  createSelector(
    selectGlobal,
    globalState => globalState.get('projectsExportsServerMaps'),
  );
...
const makeSelectProjectsNextValues = () =>
  createSelector(
    selectGlobal,
    globalState => globalState.get('projectsNextValues'),
  );

const makeSelectProjectsEntriesFinder = () =>
  createSelector(
    selectGlobal,
    globalState => globalState.get('projectsEntriesFinder'),
  );
