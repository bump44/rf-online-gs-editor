...
import { getFixshield } from '~/containers/App/getters/projectSkillForce';
import ProjectSkillForceFieldFormattedMessage from '../FieldFormattedMessage';

/* eslint-disable react/prefer-stateless-function */
class ProjectSkillForceInteractingFixshield extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  renderCheckbox(message) {
    ...
    const value = getFixshield(skillForceNextValues.get('nextValue'), {
      entry: skillForce,
    });
  ...
  render() {
    return (
      <ProjectSkillForceFieldFormattedMessage message="Fixshield">
        {this.renderCheckbox}
...
ProjectSkillForceInteractingFixshield.propTypes = {
...
ProjectSkillForceInteractingFixshield.defaultProps = {
  className: '',
};

export default ProjectSkillForceInteractingFixshield;
