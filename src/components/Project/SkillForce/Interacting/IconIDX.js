/**
 *
 * ProjectSkillForceInteractingIconIDX
 *
 */
...
import { getIconIDX } from '~/containers/App/getters/projectSkillForce';
import ProjectSkillForceFieldFormattedMessage from '../FieldFormattedMessage';

/* eslint-disable react/prefer-stateless-function */
class ProjectSkillForceInteractingIconIDX extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  renderInput(message) {
    ...
    const value = getIconIDX(skillForceNextValues.get('nextValue'), {
      entry: skillForce,
    });
  ...
  render() {
    return (
      <ProjectSkillForceFieldFormattedMessage message="IconIDX">
        {this.renderInput}
...
ProjectSkillForceInteractingIconIDX.propTypes = {
...
ProjectSkillForceInteractingIconIDX.defaultProps = {
  size: 'mini',
  className: '',
  label: null,
  fluid: true,
...
export default ProjectSkillForceInteractingIconIDX;
