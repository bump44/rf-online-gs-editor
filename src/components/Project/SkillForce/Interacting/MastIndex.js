/**
 *
 * ProjectSkillForceInteractingMastIndex
 *
 */
...
import { getMastIndex } from '~/containers/App/getters/projectSkillForce';
import ProjectSkillForceFieldFormattedMessage from '../FieldFormattedMessage';

/* eslint-disable react/prefer-stateless-function */
class ProjectSkillForceInteractingMastIndex extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  renderInput(message) {
    ...
    const value = getMastIndex(skillForceNextValues.get('nextValue'), {
      entry: skillForce,
    });
  ...
  render() {
    return (
      <ProjectSkillForceFieldFormattedMessage message="MastIndex">
        {this.renderInput}
...
ProjectSkillForceInteractingMastIndex.propTypes = {
...
ProjectSkillForceInteractingMastIndex.defaultProps = {
  size: 'mini',
  className: '',
  label: null,
  fluid: true,
...
export default ProjectSkillForceInteractingMastIndex;
