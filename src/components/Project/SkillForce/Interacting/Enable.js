...
import { getEnable } from '~/containers/App/getters/projectSkillForce';
import ProjectSkillForceFieldFormattedMessage from '../FieldFormattedMessage';

/* eslint-disable react/prefer-stateless-function */
class ProjectSkillForceInteractingEnable extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  renderCheckbox(message) {
    ...
    const value = getEnable(skillForceNextValues.get('nextValue'), {
      entry: skillForce,
    });
  ...
  render() {
    return (
      <ProjectSkillForceFieldFormattedMessage message="Enable">
        {this.renderCheckbox}
...
ProjectSkillForceInteractingEnable.propTypes = {
...
ProjectSkillForceInteractingEnable.defaultProps = {
  className: '',
};

export default ProjectSkillForceInteractingEnable;
