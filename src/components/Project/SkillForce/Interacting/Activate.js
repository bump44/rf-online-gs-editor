...
import { getActivate } from '~/containers/App/getters/projectSkillForce';
import ProjectSkillForceFieldFormattedMessage from '../FieldFormattedMessage';

/* eslint-disable react/prefer-stateless-function */
class ProjectSkillForceInteractingActivate extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  renderCheckbox(message) {
    ...
    const value = getActivate(skillForceNextValues.get('nextValue'), {
      entry: skillForce,
    });
  ...
  render() {
    return (
      <ProjectSkillForceFieldFormattedMessage message="Activate">
        {this.renderCheckbox}
...
ProjectSkillForceInteractingActivate.propTypes = {
...
ProjectSkillForceInteractingActivate.defaultProps = {
  className: '',
};

export default ProjectSkillForceInteractingActivate;
