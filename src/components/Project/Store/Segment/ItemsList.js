...
class ProjectStoreSegmentItemsList extends React.PureComponent {
  render() {
    const {
      style,
      store,
...
ProjectStoreSegmentItemsList.propTypes = {
...
ProjectStoreSegmentItemsList.defaultProps = {
  style: {},
};

export default ProjectStoreSegmentItemsList;
