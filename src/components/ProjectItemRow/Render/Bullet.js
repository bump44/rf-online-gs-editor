...
class ProjectItemRowRenderBullet extends React.PureComponent {
  render() {
...
ProjectItemRowRenderBullet.propTypes = {
...
export default ProjectItemRowRenderBullet;
