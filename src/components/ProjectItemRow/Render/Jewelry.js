...
class ProjectItemRowRenderJewelry extends React.PureComponent {
  render() {
    const {
      item,
      itemNextValues,
...
ProjectItemRowRenderJewelry.propTypes = {
...
export default ProjectItemRowRenderJewelry;
